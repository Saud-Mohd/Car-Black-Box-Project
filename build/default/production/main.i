...
void main(void)
{
 ...
 int menu_pos = 0;
    ...
    while(1)
    {
         ...
         else if(key == 0x37 && control_flag == 0x01)
         {
             clcd_write(0x01, 0);
         ...
         else if (key == 0xB7 && control_flag == 0x04)
         {
             switch(menu_pos)
             {
         ...
         else if (key == 0xAF && control_flag == 0x04)
         {
             clcd_write(0x01, 0);
             clcd_write(0x0C, 0);
         ...
         else if (key == 0xAF && (control_flag == 0x08 || control_flag == 0x80 || control_flag == 0x40))
         {
             clcd_write(0x01, 0);
             clcd_write(0x0C, 0);
             control_flag = 0x04;
         ...
         switch (control_flag)
         {
             ...
             case 0x10:
                 ...
                 break;
             case 0x20:
                 if(download_log(reset_flag) == 0x11)
                 {
                     control_flag = 0x04;
                     reset_flag = 0x02;
                     clcd_write(0x01, 0);
